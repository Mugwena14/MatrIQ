const questions = [
    ...
    },
    {
        ...
        answerOptions: [
            ...
            { answerText: 'Pressure is absorbed at B', isCorrect: true },
            { answerText: 'Pressure is absorbed at A and C', isCorrect: false },
            { answerText: 'Pressure is released at C', isCorrect: false },
        ],
        image: 'data:image/png;base64,...', 
        explanation: 'At B, pressure is absorbed through the round window, maintaining fluid balance.',
    },
    {
    ...
    answerOptions: [
        ...
        { answerText: 'Cristae', isCorrect: true },
        { answerText: 'Auditory receptors', isCorrect: false },
    ],
    image: 'data:image/png;base64,...',
    explanation: 'Crirate detect changes in speed and direction of movement of the head, helping maintain balance and spatial orientation.',
    },
    {
    questionText: 'Which ONE of the ossicles transfers vibrations to the oval window?',
    answerOptions: [
        { answerText: 'Stapes/Stirrup', isCorrect: true },
        { answerText: 'Cochlea', isCorrect: false },
        { answerText: 'Malleus', isCorrect: false },
        { answerText: 'Incus', isCorrect: false },
    ],
    image: 'data:image/png;base64,...',
    explanation: 'The stapes/stirrup is the ossicle that transfers vibrations to the oval window, facilitating the transmission of sound waves into the inner ear.',
    },
    {
    ...
    answerOptions: [
        ...
        { answerText: 'Gravitropism/Geotropism', isCorrect: true },
        { answerText: 'Phototropism', isCorrect: false },
    ],
    image: 'data:image/png;base64,...',
    explanation: 'Gravitropism/Geotropism is the growth reaction of a plant in response to gravity, where roots grow downward and shoots grow upward.',
    },
    {
    ...
    answerOptions: [
        ...
        { answerText: 'Gibberellins', isCorrect: true },
    ],
    image: 'data:image/png;base64,...',
